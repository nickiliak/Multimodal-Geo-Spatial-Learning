...
| Model | R@1 img | R@1 mean | R@1 max | R@1 attn | R@10 img | R@10 mean | R@10 max | R@25 img | R@25 mean | R@25 max | mAP img | mAP mean | mAP max |
|-------|---------|----------|---------|----------|----------|-----------|----------|----------|-----------|----------|---------|----------|---------|
| Zero-shot | 0.34% | 0.40% | 0.30% | 0.30% | 2.14% | 1.80% | 2.10% | 3.88% | 3.50% | 3.30% | 1.00% | 0.89% | 0.89% |
| v2 (ep30) | 7.21% | 17.60% | **9.00%** | 17.50% | 25.32% | **42.20%** | 27.20% | 34.35% | **51.50%** | 37.00% | 13.10% | 25.50% | 15.21% |
| v3 (ep36) | **8.58%** | 18.40% | 7.10% | 18.20% | 22.29% | 37.20% | 18.80% | 27.47% | 43.60% | 25.40% | 13.25% | 25.12% | 11.10% |
| v4 (ep36) | 7.63% | **18.50%** | 8.10% | 18.20% | 24.58% | 39.60% | 25.30% | **33.13%** | 50.10% | **33.40%** | **13.34%** | **25.33%** | 13.72% |
...
| Model | Backbone | img_size | Epochs | R@1 | R@10 | R@25 | mAP@1k |
|-------|----------|----------|--------|-----|------|------|--------|
| Zero-shot | fb_in22k_ft_1k_384 | 384 | 0 | 0.34% | 2.14% | 3.88% | 1.00% |
| v2 (ep30) | fb_in22k | 224 | 35 | 7.21% | 25.32% | 34.35% | 13.10% |
| v3 (ep36) | fb_in22k_ft_1k_384 | 384 | 36 | **8.58%** | 22.29% | 27.47% | 13.25% |
| v4 (ep36) | fb_in22k | 224 | 36 | 7.63% | 24.58% | 33.13% | 13.34% |
